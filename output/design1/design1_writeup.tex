...
The price effect moves from $6.4$ to $5.7$ to $5.5$ (all $p<0.01$),
borrower income is essentially untouched ($8.1$, $7.8$, $7.9$, all
$p<0.01$), and non-Hispanic purchase entry ($100\times$asinh) goes $12.7$,
$12.2$, $10.1$ (all $p<0.01$), while Hispanic purchase counts stay a
precise null throughout. Table~\ref{tab:ring_controls_robustness} runs the
same ladder on the ring design's cell panel (specification (1) reproduces
the baseline estimates exactly): the price effect goes $5.3$, $4.2$, $2.5$
($p<0.01$, $p<0.01$, $p<0.10$) and the net ownership-conversion rate
$2.4$, $2.5$, $2.2$pp (all $p<0.05$). County-year shocks and
observable-trend selection account for at most a modest share of every
estimate; the price effects' third column, identified within
municipio-year among observably similar units, remains economically large.
