...
Hispanic --- side of the market. Two results: the \emph{number} of
Hispanic-borrower purchase originations shows no significant pooled change
($-0.8$\%, s.e.\ $5.3$; not shown), though it drifts negative at longer
horizons ($-16.0$\%, s.e.\ $8.2$ at $h\!\ge\!3$); and the \emph{income} of
purchase borrowers rises after treatment
(Figure~\ref{fig:hmdainc}) --- pooled $+10.7$\% (s.e.\ $2.6$), reaching
